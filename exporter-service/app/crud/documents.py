...
def get_document_by_id_xlsx(db:Database,current_user:User,document_id:str)->str:
    #TODO: If the document doesn't belong to the user, return 401 unauthorized
...
def get_documents_by_workflow(db:Database,current_user:User,workflow_id:int):

...
const Templates = () => {
  const [templates, setTemplates] = useState([
    { id: 1, title: 'Template 1', description: 'template description', date: '10/05/2024 17:45' },
    { id: 2, title: 'Template 2', description: 'template description', date: '10/05/2024 17:45' },
    { id: 3, title: 'Template 3', description: 'template description', date: '10/05/2024 17:45' },
    { id: 4, title: 'Template 4', description: 'template description', date: '10/05/2024 17:45' },
  ]);
  ...
  return (
    <div className="border-2 border-blue-[#5583C5] rounded-lg w-45 min-h-[600px] h-auto mx-20 my-5 p-5 flex flex-col justify-between">
        ...
        {templates.map(template => (
            ...
            <p className="text-gray-500 text-sm mt-2">{template.date}</p>
            </div>
        ))}
        </div>
